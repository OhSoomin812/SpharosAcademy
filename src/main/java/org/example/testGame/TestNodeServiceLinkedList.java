...
public class TestNodeServiceLinkedList {

    private final LinkedList<TestNode> tests;

    public TestNodeServiceLinkedList() {
    ...
    public void initTestNodes() {
        ...
        q6.yes = q10; q6.no = q7;
        q7.yes = q11; q7.no = q8;
        q8.yes = q12; q8.no = q10;
        q9.yes = aType; q9.no = q6;
        q10.yes = bType; q10.no = q11;
        q11.yes = cType; q11.no = dType;
        q12.yes = dType; q12.no = q11;
    }
